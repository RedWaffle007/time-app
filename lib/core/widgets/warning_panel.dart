...
///
/// This is the largest `attentionContainer` fill in the app: a value tuned on a
/// Pending badge is not proven here. `lib/dev/theme_preview.dart` renders it at
/// size next to the badges for exactly that reason.
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: context.attentionContainer,
